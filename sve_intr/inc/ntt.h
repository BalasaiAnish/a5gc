...
inline svint16_t montgomery_reduce(svint32_t, svbool_t);
inline svint16_t fqmul(svint16_t, svint16_t, svbool_t);

inline svint16_t montgomery_reduce(svint32_t, svbool_t);

inline svint16_t fqmul(svint16_t, svint16_t, svbool_t);

inline svint16_t svcat2_s16(svint16_t, svint16_t, unsigned int);

inline svint16_t svcat4_s16(svint16_t, svint16_t, svint16_t, svint16_t, unsigned int);

inline svint16_t svcat8_s16(svint16_t, svint16_t, svint16_t, svint16_t,
    svint16_t, svint16_t, svint16_t, svint16_t, unsigned int);

inline svint16_t svcat16_s16(svint16_t, svint16_t, svint16_t, svint16_t,
