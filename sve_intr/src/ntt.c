...
inline svint16_t svcat32_s16(svint16_t reg0, svint16_t reg1, svint16_t reg2, svint16_t reg3,
    svint16_t reg4, svint16_t reg5, svint16_t reg6, svint16_t reg7,
    svint16_t reg8, svint16_t reg9, svint16_t reg10, svint16_t reg11,
    svint16_t reg12, svint16_t reg13, svint16_t reg14, svint16_t reg15,
    svint16_t reg16, svint16_t reg17, svint16_t reg18, svint16_t reg19,
    svint16_t reg20, svint16_t reg21, svint16_t reg22, svint16_t reg23,
    svint16_t reg24, svint16_t reg25, svint16_t reg26, svint16_t reg27,
    svint16_t reg28, svint16_t reg29, svint16_t reg30, svint16_t reg31,
    unsigned int vl) {
    svbool_t half = svwhilelt_b16_u32(0, vl/2);
    svbool_t quarter = svwhilelt_b16_u32(0, vl/4);
    svbool_t eigth = svwhilelt_b16_u32(0, vl/8);
    svbool_t sixteenth = svwhilelt_b16_u32(0, vl/16);
    svbool_t thirtysecondth = svwhilelt_b16_u32(0, vl/32);

    reg0 = svsplice_s16(thirtysecondth, reg0, reg1);
    reg2 = svsplice_s16(thirtysecondth, reg2, reg3);
    reg4 = svsplice_s16(thirtysecondth, reg4, reg5);
    reg6 = svsplice_s16(thirtysecondth, reg6, reg7);
    reg8 = svsplice_s16(thirtysecondth, reg8, reg9);
    reg10 = svsplice_s16(thirtysecondth, reg10, reg11);
    reg12 = svsplice_s16(thirtysecondth, reg12, reg13);
    reg14 = svsplice_s16(thirtysecondth, reg14, reg15);
    reg16 = svsplice_s16(thirtysecondth, reg16, reg17);
    reg18 = svsplice_s16(thirtysecondth, reg18, reg19);
    reg20 = svsplice_s16(thirtysecondth, reg20, reg21);
    reg22 = svsplice_s16(thirtysecondth, reg22, reg23);
    reg24 = svsplice_s16(thirtysecondth, reg24, reg25);
    reg26 = svsplice_s16(thirtysecondth, reg26, reg27);
    reg28 = svsplice_s16(thirtysecondth, reg28, reg29);
    reg30 = svsplice_s16(thirtysecondth, reg30, reg31);

    reg0 = svsplice_s16(sixteenth, reg0, reg2);
    reg2 = svsplice_s16(sixteenth, reg4, reg6);
    reg4 = svsplice_s16(sixteenth, reg8, reg10);
    reg6 = svsplice_s16(sixteenth, reg12, reg14);
    reg8 = svsplice_s16(sixteenth, reg16, reg18);
    reg10 = svsplice_s16(sixteenth, reg20, reg22);
    reg12 = svsplice_s16(sixteenth, reg24, reg26);
    reg14 = svsplice_s16(sixteenth, reg28, reg30);
...
inline void butterfly_level4(int16_t r[256], int16_t zeta0, int16_t zeta1, int16_t zeta2, int16_t zeta3,
    int16_t zeta4, int16_t zeta5, int16_t zeta6, int16_t zeta7,
    int16_t zeta8, int16_t zeta9, int16_t zeta10, int16_t zeta11,
    int16_t zeta12, int16_t zeta13, int16_t zeta14, int16_t zeta15,
    unsigned int start0, unsigned int start1, unsigned int start2, unsigned int start3,
    unsigned int start4, unsigned int start5, unsigned int start6, unsigned int start7,
    unsigned int start8, unsigned int start9, unsigned int start10, unsigned int start11,
    unsigned int start12, unsigned int start13, unsigned int start14, unsigned int start15,
    unsigned int len) {
    svbool_t pred;
    svbool_t pred_half0, pred_eigth0, pred_eigth1, pred_eigth2, pred_eigth3;
    svbool_t pred_eigth4, pred_eigth5, pred_eigth6, pred_eigth7;
